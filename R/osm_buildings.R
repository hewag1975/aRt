...
# mapview::mapview(bld$osm_polygons)
# mapview::mapview(bld$osm_points)
...
p = ggplot() +
    ...
    theme(
        plot.title = element_text(
            ...
            , hjust = .5
            , colour = col
            , margin = margin(15, r = 0, b = 0, l = 0, unit = "mm")
        )
...
ggsave(
    paste0("img/nuernberg_buildings_", bg, ".jpg")
    , device = "jpeg"
    # , plot = p
    , width = 600
    , height = 600
